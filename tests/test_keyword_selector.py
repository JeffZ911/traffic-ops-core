...
def test_execute_rejects_blacklisted_article_type():
    ...
    candidates_rows = [
        (KW_ID, "nte banner schedule 2026", "informational", 80, "manual", None, None, None, None),
        ("11111111-1111-1111-1111-111111111111", "nte how pity works", "informational", 70, "manual", None, None, None, None),
    ]
    llm_text = (
...
def test_execute_rejects_unknown_article_type():
    KW_ID = "00000000-0000-0000-0000-000000000001"
    candidates_rows = [
        (KW_ID, "nte how pity works", "informational", 70, "manual", None, None, None, None),
    ]
    llm_text = (
        f'{{"keyword_id": "{KW_ID}",'
        '"keyword_text": "nte how pity works",'
...
def test_execute_filters_blacklisted_candidates_before_llm():
    ...
    candidates_rows = [
        ("11111111-1111-1111-1111-111111111111", "nte current banner schedule", "informational", 90, "manual", None, None, None, None),
        ("22222222-2222-2222-2222-222222222222", "nte how pity works", "informational", 70, "manual", None, None, None, None),
    ]
